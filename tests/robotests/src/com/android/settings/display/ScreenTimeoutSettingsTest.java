...
public class ScreenTimeoutSettingsTest {
    ...
    public void getCandidates_enforcedAdmin_timeoutIsLimited() {
        ...
        when(mResources.getInteger(R.integer.config_max_screen_timeout)).thenThrow(
                new Resources.NotFoundException("Invalid resource"));
    ...
    public void getCandidates_configuredMaxTimeout_300000_timeoutIsNotLimited() {
        ...
        assertThat(candidates.size() == TIMEOUT_VALUES.length);
    }
