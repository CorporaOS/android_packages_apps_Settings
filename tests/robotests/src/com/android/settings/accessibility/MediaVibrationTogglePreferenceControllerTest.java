...
public class MediaVibrationTogglePreferenceControllerTest {
    ...
    @Test
    public void configForMediaVibration_enabled_shouldShowToogle() throws Exception {
    ...
    @Test
    public void configForMediaVibration_disabled_shouldHideToggle() throws Exception {
