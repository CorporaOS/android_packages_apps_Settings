...
public class MagnifyNavAndImePreferenceControllerTest {
    ...
    @Test
    public void isChecked_defaultStateForMagnifyNavAndIme_onResumeShouldReturnFalse() {
    ...
    @Test
    public void isChecked_enableMagnifyNavAndIme_onResumeShouldReturnTrue() {
    ...
    @Test
    public void isChecked_disableMagnifyNavAndIme_onResumeShouldReturnFalse() {
    ...
    @Test
    public void performClick_switchDefaultStateForMagnifyNavAndIme_shouldReturnFalse() {
        mController.onResume();
    ...
    @Test
    public void updateState_disableMagnifyNavAndIme_shouldReturnFalse() {
        Settings.Secure.putInt(mContext.getContentResolver(), KEY_MAGNIFY_NAV_AND_IME, OFF);
