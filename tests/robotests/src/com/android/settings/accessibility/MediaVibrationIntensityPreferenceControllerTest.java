...
public class MediaVibrationIntensityPreferenceControllerTest {
    ...
    @Test
    public void configForMediaVibration_enabled_shouldShowSlider() throws Exception {
    ...
    @Test
    public void configForMediaVibration_disabled_shouldHideSlider() throws Exception {
