...
public class BluetoothSnoopLogFilterProfilePbapPreferenceControllerTest {
    ...
    public void verifyResourceSizeAndRange() {
        assertThat(BluetoothSnoopLogFilterProfilePbapPreferenceController.isProfilesFilteringEnabled());
    ...
    public void onPreferenceChanged_turnOnBluetoothSnoopLogFullFilterPbap() {
        ...
        mController.onPreferenceChange(null,
                mListValues[BluetoothSnoopLogFilterProfilePbapPreferenceController.BTSNOOP_LOG_PROFILE_FILTER_MODE_FULL_FILTER_INDEX]);
        var mode = BluetoothProperties.snoop_log_filter_profile_pbap()
        ...
        assertThat(mode).isEqualTo(BluetoothProperties.snoop_log_filter_profile_pbap_values.FULLFILTER);
    }
    ...
    public void onPreferenceChanged_turnOnBluetoothSnoopLogHeaderFilterPbap() {
        assertThat(BluetoothSnoopLogFilterProfilePbapPreferenceController.isProfilesFilteringEnabled());
        mController.onPreferenceChange(null,
                mListValues[BluetoothSnoopLogFilterProfilePbapPreferenceController.BTSNOOP_LOG_PROFILE_FILTER_MODE_HEADER_INDEX]);
        var mode = BluetoothProperties.snoop_log_filter_profile_pbap()
                .orElse(BluetoothProperties.snoop_log_filter_profile_pbap_values.DISABLED);
        // "header" is hard-coded between Settings and system/bt
        assertThat(mode).isEqualTo(BluetoothProperties.snoop_log_filter_profile_pbap_values.HEADER);
    }
    ...
    public void onPreferenceChanged_turnOnBluetoothSnoopLogMagicFilterPbap() {
        assertThat(BluetoothSnoopLogFilterProfilePbapPreferenceController.isProfilesFilteringEnabled());
        mController.onPreferenceChange(null,
                mListValues[BluetoothSnoopLogFilterProfilePbapPreferenceController.BTSNOOP_LOG_PROFILE_FILTER_MODE_MAGIC_INDEX]);
        var mode = BluetoothProperties.snoop_log_filter_profile_pbap()
                .orElse(BluetoothProperties.snoop_log_filter_profile_pbap_values.DISABLED);
        // "magic" is hard-coded between Settings and system/bt
        assertThat(mode).isEqualTo(BluetoothProperties.snoop_log_filter_profile_pbap_values.MAGIC);
    }
    ...
    public void onPreferenceChanged_turnOffBluetoothSnoopLogFilterPbap() {
        assertThat(BluetoothSnoopLogFilterProfilePbapPreferenceController.isProfilesFilteringEnabled());
        mController.onPreferenceChange(null,
                mListValues[BluetoothSnoopLogFilterProfilePbapPreferenceController.BTSNOOP_LOG_PROFILE_FILTER_MODE_DISABLED_INDEX]);
        var mode = BluetoothProperties.snoop_log_filter_profile_pbap()
                .orElse(BluetoothProperties.snoop_log_filter_profile_pbap_values.DISABLED);
        // "disabled" is hard-coded between Settings and system/bt
        assertThat(mode).isEqualTo(BluetoothProperties.snoop_log_filter_profile_pbap_values.DISABLED);
    }
