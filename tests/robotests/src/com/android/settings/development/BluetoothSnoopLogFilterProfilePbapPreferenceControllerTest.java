...
public class BluetoothSnoopLogFilterProfilePbapPreferenceControllerTest {
    ...
    public void onPreferenceChanged_turnOnBluetoothSnoopLogFullFilterPbap() {
        ...
        final String mode = SystemProperties.get(
                SnoopLoggerFiltersUtils.BLUETOOTH_BTSNOOP_LOG_PBAP_FILTER_MODE_PROPERTY);
    ...
    public void updateState_preferenceShouldBeSetToRightValue() {
        ...
        for (int i = 0; i < mListValues.length; ++i) {
            SystemProperties.set(SnoopLoggerFiltersUtils.BLUETOOTH_BTSNOOP_LOG_PBAP_FILTER_MODE_PROPERTY,
