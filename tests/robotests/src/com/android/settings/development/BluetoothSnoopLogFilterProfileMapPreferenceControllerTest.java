...
public class BluetoothSnoopLogFilterProfileMapPreferenceControllerTest {
    ...
    public void verifyResourceSizeAndRange() {
        assertThat(BluetoothSnoopLogFilterProfileMapPreferenceController.isProfilesFilteringEnabled());
    ...
    public void onPreferenceChanged_turnOnBluetoothSnoopLogFullFilterMap() {
        ...
        var mode = BluetoothProperties.snoop_log_filter_profile_map()
        ...
        assertThat(mode).isEqualTo(BluetoothProperties.snoop_log_filter_profile_map_values.FULLFILTER);
    }
    ...
    public void onPreferenceChanged_turnOffBluetoothSnoopLogFilterMap() {
        ...
        assertThat(mode).isEqualTo(BluetoothProperties.snoop_log_filter_profile_map_values.DISABLED);
    }
