...
public class ResetSubscriptionContractTest {
    ...
    @Test
    public void getMissingSubscriptionId_returnNull_whenNoSubscriptionChange() {
        ...
        assertNull(target.getMissingSubscriptionId());
    }

    @Test
    public void getMissingSubscriptionId_returnSubId_whenSubscriptionNotActive() {
        mRequestArgs.setResetTelephonyAndNetworkPolicyManager(SUB_ID_1);
        doReturn(mSubscriptionInfo1).when(mSubscriptionManager)
                .getActiveSubscriptionInfo(SUB_ID_1);
        mRequestArgs.setResetApn(SUB_ID_2);
        ...
        assertEquals(target.getMissingSubscriptionId(), new Integer(SUB_ID_2));
    }
}
