    ...
    private static final class FakeThreadNetworkController implements BaseThreadNetworkController {
        ...
        public void setEnabled(
            ...
            if (mStateCallback != null) {
                if (!mIsEnabled) {
                    mExecutor.execute(() -> mStateCallback.onThreadEnableStateChanged(STATE_DISABLING));
                    mExecutor.execute(() -> mStateCallback.onThreadEnableStateChanged(STATE_DISABLED));
                } else {
                    mExecutor.execute(() -> mStateCallback.onThreadEnableStateChanged(STATE_ENABLED));
                }
