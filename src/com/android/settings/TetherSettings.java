...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        // Etherent service will be started if either of FEATURE_ETHERNET and FEATURE_USB_HOST or
        // both are supported on device, check the availability of ethernet interface via fetching
        // a NonNull EthernetManager instance.
