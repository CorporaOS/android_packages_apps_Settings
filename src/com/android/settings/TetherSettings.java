...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    @Nullable
    private static EthernetManager getEthernetManager(final Context context) {
        if (context != null
                && context.getPackageManager().hasSystemFeature(PackageManager.FEATURE_ETHERNET)) {
    ...
    void updateEthernetState(String[] available, String[] tethered) {
        ...
        } else if (isAvailable || (mAvailableInterfaces.size() > 0)) {
            mEthernetTether.setEnabled(!mDataSaverEnabled);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    final boolean ethernetAvailable = (getEthernetManager(context) != null);
