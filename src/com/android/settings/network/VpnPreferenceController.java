...
public class VpnPreferenceController extends AbstractPreferenceController
    ...
    protected String getInsecureVpnSummaryOverride(UserManager userManager,
        ...
        if (mPreference instanceof VpnInfoPreference) {
            ...
            if (replaceVpnProfileStore()) {
                legacyVpnProfileKeys = vpnManager.listFromVpnProfileStore(Credentials.VPN);
            } else {
    ...
    protected int getInsecureVpnCount(VpnManager vpnManager, String [] legacyVpnProfileKeys) {
        ...
        if (replaceVpnProfileStore()) {
            keyToProfile = key -> VpnProfile.decode(key,
                    vpnManager.getFromVpnProfileStore(Credentials.VPN + key));
        } else {
            keyToProfile = key ->
