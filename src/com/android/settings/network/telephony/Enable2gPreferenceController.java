 ...
 * operation. The requested 2g preference is forwarded to
 * {@link TelephonyManager#setAllowedNetworkTypesForReason(int reason, long allowedNetworkTypes)}
 * by setting or clearing the network type bits associated with 2g in the {@code
 * allowedNetworkTypes} param.
 */
