...
public class ResetNetworkOperationBuilder {
     ...
     * @return this
     */
    public ResetNetworkOperationBuilder resetEsim(Consumer<Boolean> resultCallback) {
        Runnable runnable = () -> {
            Boolean wipped = RecoverySystem.wipeEuiccData(mContext, mContext.getPackageName());
