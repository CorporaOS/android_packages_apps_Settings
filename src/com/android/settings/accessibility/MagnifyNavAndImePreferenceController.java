...
/** Controller that accesses and switches
 * the preference status of magnifying the nav bar and IME feature
 */
public class MagnifyNavAndImePreferenceController extends TogglePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mMagnifyNavImePreference = screen.findPreference(getPreferenceKey());
    }
     ...
     * {@link MagnifyNavAndImePreferenceController#displayPreference}.
     */
    void updateState() {
        updateState(mMagnifyNavImePreference);
    }
}
