...
public class DefaultPaymentSettings extends DefaultAppPickerFragment/*RadioButtonPickerFragment*/ {
    ...
    protected String getDefaultKey() {
        ...
        if (defaultAppInfo != null) {
            return defaultAppInfo.componentName.flattenToString() + " " + defaultAppInfo.userHandle.getIdentifier();
        }
        return null;
    }
    ...
    protected CharSequence getConfirmationMessage(CandidateInfo appInfo) {
        ...
        titleString.setSpan(new AlignmentSpan.Standard(Layout.Alignment.ALIGN_CENTER), 0, title.length(),
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        messageString.setSpan(new AlignmentSpan.Standard(Layout.Alignment.ALIGN_CENTER), 0, messageTitle.length(),
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
