...
public class WifiTetherViewModel extends AndroidViewModel {
    ...
    private static void updateSecuritySummaryMap() {
        ...
        if(mIsOweTransitionSupported && !sSecuritySummaryResMap.containsKey(SECURITY_TYPE_WPA3_OWE_TRANSITION)) {
            sSecuritySummaryResMap.put(
                    SECURITY_TYPE_WPA3_OWE_TRANSITION, com.android.settingslib.R.string.wifi_security_none_owe);
        } else if (!mIsOweTransitionSupported && sSecuritySummaryResMap.containsKey(SECURITY_TYPE_WPA3_OWE_TRANSITION)) {
