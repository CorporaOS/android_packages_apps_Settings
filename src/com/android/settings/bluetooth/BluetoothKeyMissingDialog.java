...
public class BluetoothKeyMissingDialog extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /*
         * Leave this registered, we want to finish the activity in the background if pairing is
         * started.
         */
    ...
    void doPositiveClick() {
        Log.i(TAG, "Positive click, removing bond");
        mDevice.removeBond();
        dismiss();
    }

    void doNegativeClick() {
        Log.i(TAG, "Negative click, dismissing dialog");
        dismiss();
    }
