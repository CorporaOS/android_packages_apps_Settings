...
public class ResetSubscriptionContract implements AutoCloseable {
     ...
     */
    public ResetSubscriptionContract(Context context,
            ResetNetworkRequest resetRequest) {
        mContext = context;
     ...
     */
    public Integer getMissingSubscriptionId() {
        if (mResetSubscriptionIds.length <= 0) {
            return null;
        }
            ...
            public void onSubscriptionsChanged() {
                ...
                mContext.getMainExecutor().execute(() -> {
                    ...
                    if (mSubscriptionsUpdateNotify.getAndSet(false)) {
                        Integer subId = getMissingSubscriptionId();
                        if (subId != null) {
