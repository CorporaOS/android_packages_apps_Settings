...
public class BluetoothSnoopLogFilterProfilePbapPreferenceController
    ...
    @VisibleForTesting
    static boolean isProfilesFilteringEnabled() {
        return (BluetoothProperties.snoop_log_filter_types().contains(
                BluetoothProperties.snoop_log_filter_types_values.PROFILESFILTERED)
                && BluetoothProperties.snoop_log_mode().orElse(
    ...
    public BluetoothSnoopLogFilterProfilePbapPreferenceController(Context context) {
        ...
        mProfilesFilterDisabledEntry = context.getResources().getString(
            R.string.bt_hci_snoop_log_profilesfilter_disabled_summary);
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (isProfilesFilteringEnabled() || ((ListPreference) preference).getValue() == null) {
            mPreference.setEnabled(true);
            final ListPreference listPreference = (ListPreference) preference;
            var currentValue = BluetoothProperties.snoop_log_filter_profile_pbap()
            ...
            ((ListPreference) preference).setSummary(mProfilesFilterDisabledEntry);
        }
    }
    ...
    protected void onDeveloperOptionsSwitchEnabled() {
        ...
        mPreference.setEnabled(isProfilesFilteringEnabled());
    }
