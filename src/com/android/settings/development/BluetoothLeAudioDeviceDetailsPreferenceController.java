...
public class BluetoothLeAudioDeviceDetailsPreferenceController
    ...
    static int sLeAudioSupportedState = BluetoothStatusCodes.ERROR_UNKNOWN;
    ...
    public boolean isAvailable() {
        ...
        if (sLeAudioSupportedState == BluetoothStatusCodes.ERROR_UNKNOWN) {
            ...
            if (isLeAudioSupported != BluetoothStatusCodes.ERROR_BLUETOOTH_NOT_ENABLED) {
                sLeAudioSupportedState = isLeAudioSupported;
            }
        }

        // Display the option only if LE Audio is supported
        return (sLeAudioSupportedState == BluetoothStatusCodes.FEATURE_SUPPORTED);
    }
