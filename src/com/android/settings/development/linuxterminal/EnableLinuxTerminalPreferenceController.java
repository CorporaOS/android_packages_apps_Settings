...
public class EnableLinuxTerminalPreferenceController extends BasePreferenceController
    ...
    public void onCheckedChanged(@NonNull CompoundButton buttonView, boolean isChecked) {
        ...
        if (!isChecked) {
            mPackageManager.clearApplicationUserData(
                    getTerminalPackageName(), /* observer= */ null);
        }
    }
    ...
    public void updateState(@NonNull Preference preference) {
        ...
        String packageName = getTerminalPackageName();
        boolean isInstalled = (packageName != null);
        if (isInstalled) {
            ...
            if (isPrimaryUser()) {
                Log.e(TAG, "Terminal app doesn't exist for primary user");
                mPreference.setDisabledByAdmin(/* admin= */ null);
    ...
    boolean isPrimaryUser() {
        return mUserId == UserHandle.myUserId();
    }
