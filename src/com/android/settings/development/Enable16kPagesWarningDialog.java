...
public class Enable16kPagesWarningDialog extends InstrumentedDialogFragment
    ...
    private static volatile Enable16kbPagesDialogHost sDialogHost;

    /** Used to display warning dialog */
    public static void show(@NonNull Fragment host, @NonNull Enable16kbPagesDialogHost controller) {
