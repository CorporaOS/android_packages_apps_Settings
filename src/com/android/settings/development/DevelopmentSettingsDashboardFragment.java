...
public class DevelopmentSettingsDashboardFragment extends RestrictedDashboardFragment
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        ...
        if (isChecked != developmentEnabledState) {
            if (isChecked) {
                ...
                if ((a2dpController == null || a2dpController.isDefaultValue()) && (leAudioController == null || leAudioController.isDefaultValue())) {
                    disableDeveloperOptions();
                } else {
    ...
    public void onHwOffloadDialogConfirmed() {
        ...
        final BluetoothLeAudioHwOffloadPreferenceController leAudioController =
                getDevelopmentOptionsController(BluetoothLeAudioHwOffloadPreferenceController.class);
