...
/**
 * Enable the support of #onFragmentPreload(Context) and #isFragmentCreated().
 *
 * Note: Before #isFragmentCreated(), APIs provided by PreferenceFragment might
 *       not functional.
 */
public abstract class PreloadPreferenceFragment extends SettingsPreferenceFragment {
