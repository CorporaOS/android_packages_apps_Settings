...
import com.android.settings.connecteddevice.threadnetwork.ThreadNetworkPreferenceController;
...
public class AdvancedConnectedDeviceDashboardFragment extends DashboardFragment {
    ...
    public void onAttach(Context context) {
        ...
        if (com.android.net.thread.platform.flags.Flags.threadEnabledPlatform()) {
