...
public class StylusDevicesController extends AbstractPreferenceController implements
    ...
    @VisibleForTesting
    static final String KEY_SHOW_STYLUS_POINTER_ICON = "show_stylus_pointer_switch";
    ...
    private SwitchPreference createShowStylusPointerIconPreference(SwitchPreference preference) {
        ...
        pref.setOnPreferenceClickListener(this);
        pref.setChecked(Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.STYLUS_POINTER_ICON_ENABLED, 1) == 1);
        return pref;
    }
    ...
    private void refresh() {
        ...
        SwitchPreference currShowStylusPointerIconPref = mPreferencesContainer
