...
public class SettingsActivity extends SettingsBaseActivity
    ...
    protected void onCreate(Bundle savedState) {
        ...
        if ((mPreloadFragment != null)
                && (mPreloadFragment instanceof SettingsPreferenceFragment)) {
            ((SettingsPreferenceFragment)mPreloadFragment).onFragmentPreload(this);
        }
    ...
    private void switchToFragment(String fragmentName, Bundle args, boolean validate,
        ...
        if (f == null) {
            ...
            ((SettingsPreferenceFragment)f).onFragmentPreload(this);
        }
